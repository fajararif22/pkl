...
<body>
  ...
  <header>
    <div class="navbar navbar-dark bg-dark shadow-sm">
      <div class="container">
        <a href="<?= base_url('admin'); ?>" class="navbar-brand d-flex align-items-center">
  ...
  <main>
    ...
    <div class="text-center">
      ...
      <a href="<?= base_url('admin/blogwrite'); ?>">
        <span>Let's go!</span>
      </a>
    </div>
              ...
              <div id="post<?= $blogfeed['id_blog']; ?>">
                ...
                <div class="card-body">
                  ...
                  <div class="d-flex justify-content-between align-items-center">
                    <div class="btn-group">
                      <a class="btn btn-sm btn-outline-secondary" href="<?= base_url('admin/blogview'); ?>?p=<?= $blogfeed['id_blog']; ?>&a=<?= $blogfeed['blogwriter']; ?>" style='text-decoration: none;color: #777777;'>View</a>
                    </div>
                  </div>
                </div>
              </div>
